...
import com.easemob.chatuidemo.utils.BitmapSaveUtils;
import com.easemob.chatuidemo.utils.DrawableToBitmap;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		save_btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
	              ...
	              Bitmap  bm=DrawableToBitmap.drawable2Bitmap(db);
	             String path= BitmapSaveUtils.savePicToSdcard(bm);
	             if(path==null || path.equals("")){
	            	Toast.makeText(ShowBigImage.this, "保存失败", Toast.LENGTH_LONG).show();
	             }else{
	            	 Toast.makeText(ShowBigImage.this, "保存成功", Toast.LENGTH_LONG).show();
	             }
			}
		});
